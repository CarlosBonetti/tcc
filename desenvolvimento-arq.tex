...
Na Seção de \quotes{Conclusões e Trabalhos Futuros} do trabalho original, \cite{Silq1} citam 8 itens de melhoria que poderiam ser revisitados por trabalhos futuros. Cada um destes itens está exposto abaixo junto uma explicação de quais foram as atitudes tomadas por este trabalho para resolvê-los.
...
Este item envolve o processamento de outras informações contidas no currículo Lattes de um pesquisador a fim de credenciá-lo em um Programa de Pós-Graduação, utilizando as publicações e informações de onde foram publicados/apresentados os trabalhos e artigos do pesquisador e utilizá-los para sua avaliação automática. Este item não foi abordado neste trabalho.
