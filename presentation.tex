...
\begin{frame}{Algoritmo \texttt{query\_aliasing}}
  ...
  \hfill \\
  \textit{Queries} idênticas\\
  \quotes{Software Engineering Knowledge Engineering}\\
  Rank: 1.0\\

  \hfill \\
  \textit{Queries} similares\\
  \quotes{Software Engineering \textbf{and} Knowledge Engineering}\\
  Rank: 0.88\\

  \hfill \\
  \textit{Queries} dissimilares\\
  \quotes{IEEE Midwest Symposium on Circuits and Systems}\\
  Rank: 0.01\\
\end{frame}
