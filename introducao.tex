...
\begin{itemize}
    ...
    \item Verificar se a precisão da avaliação de currículos baseada em algoritmos de similaridade textual, pode ser melhorada utilizando \textit{feedback} de relevância.
\end{itemize}
