...
\begin{itemize}
    ...
    \item Verificar se a precisão da avaliação de currículos, baseada em algoritmos de similaridade textual, pode ser melhorada utilizando-se feedback explícito de usuários.
\end{itemize}
