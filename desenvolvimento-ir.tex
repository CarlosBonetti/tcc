...
1 & Software Engineering and Data Engineering (SEDE) & 53\% \\ \hline
2 & International Conference on Software Engineering and Knowledge Engineering (SEKE) & 49\% \\ \hline
3 & Software Engineering and Applications (SEA\_A) & 45\% \\ \hline
4 & Software Engineering for Secure Systems (SESS) & 45\% \\ \hline
5 & Annual Software Engineering Workshop (SEW) & 45\% \\
\hline
\end{tabular}
\end{center}
\end{table}
